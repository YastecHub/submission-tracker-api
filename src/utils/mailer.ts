...
<body style="font-family:Inter,Arial,sans-serif;background:#f9fafb;margin:0;padding:32px 16px;">
  <div style="max-width:560px;margin:0 auto;background:#ffffff;border-radius:16px;overflow:hidden;box-shadow:0 2px 12px rgba(0,0,0,0.08);">
    ...
    <div style="background:#1d4ed8;padding:32px 32px 24px;">
      <h1 style="color:#ffffff;margin:0;font-size:24px;font-weight:700;">Welcome to SubmitIt 👋</h1>
      <p style="color:#bfdbfe;margin:8px 0 0;font-size:14px;">Your class management companion</p>
    </div>

    <div style="padding:32px;">
      <p style="color:#111827;font-size:16px;margin-top:0;">Hi <strong>${name}</strong>,</p>
      <p style="color:#374151;font-size:15px;">
        You've been set up as the <strong>${roleLabel}</strong> on SubmitIt. ${intro}
      </p>
      ...
      <div style="margin-top:28px;text-align:center;">
        <a href="https://submitit.vercel.app"
           style="background:#1d4ed8;color:#ffffff;text-decoration:none;padding:14px 32px;border-radius:10px;font-weight:600;font-size:15px;display:inline-block;">
          Open SubmitIt
        </a>
      </div>

      <p style="color:#9ca3af;font-size:12px;margin-top:32px;text-align:center;">
        This email was sent because you logged into SubmitIt for the first time.<br/>
